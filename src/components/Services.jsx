...
import Image1 from "/assets/images/doctors/medicine1.jpg";
import Image2 from "/assets/images/doctors/medicine2.jpg";
import Image3 from "/assets/images/doctors/medicine2.jpg";
            ...
            <div className="  px-4 mb-8">
              <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <h2 className="text-lg font-bold text-gray-800 mb-2">Property Management</h2>
                  ...
                  <button className="mt-6 px-4 py-2 bg-primary text-white rounded-md hover:bg-primary_hover">
                  Learn More
                </button>
                </div>
              </div>
