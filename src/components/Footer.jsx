...
import { links } from "../utils/constants"
 ...
 const Footer = () => {
    return (
        <footer className='text-white desktop relative py-10 bg-no-repeat bg-cover' style={{boxShadow: 'inset 0 0 0 100vw rgba(0,0,0, .8)', backgroundImage:  `url('/assets/images/doctors/hospital.jpg')`}}>
            <div className="container px-6 py-8 mx-auto">
                <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                    <div>
                        <img src={'/assets/images/doctors/logo.png'} alt='logo' width={110} height={110} />
